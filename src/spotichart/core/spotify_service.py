...
class SpotifyService:
    ...
    def create_playlist_with_tracks(self, name: str, track_ids: list, description: str = '', public: bool = False):
    ...
    def create_or_update_playlist(self, name: str, track_ids: list, description: str = '', public: bool = False, update_mode: str = 'replace'):
        ...
        if existing_playlist:
            ...
            url, count, failed = self.create_playlist_with_tracks(name, track_ids, description, public)
